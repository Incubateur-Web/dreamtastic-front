    ...
    <div className="absolute bottom-0 left-0 right-0 h-2/5 bg-white bg-opacity-80 px-5 py-3">
      <div className="relative h-full">
        <div className="flex flex-col justify-around">
          ...
          <p className="text-xs">Membre depuis le 13 octobre 2019</p>
          <p className="uppercase text-violet text-xs">240 rêves postés</p>
          <p className="text-sm">Grande rêveuse depuis que je sais dormir.</p>
        </div>
        <button className="absolute bottom-0 left-0 bg-violet rounded-full px-8 py-3 text-lg font-semibold uppercase text-white">
